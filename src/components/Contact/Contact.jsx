            ...
            <div className={styles.contact}>
                <div className={styles.linkedin_div}>
                    ...
                    <a className={styles.logo_svg} href={linkedinlink} target='_blank'>
                        {/* LINKEDIN SVG */}
                        <svg xmlns="http://www.w3.org/2000/svg" className={styles.linkedin_svg} stroke='#d6d6d6' class="icon icon-tabler icon-tabler-brand-linkedin" width="72" height="72" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div className={styles.wsp_div}>
                    ...
                    <a className={styles.logo_svg} href={wsplink} target='_blank'>
                        {/* WHATSAPP SVG */}
                        <svg xmlns="http://www.w3.org/2000/svg" className={styles.wsp_svg} stroke='#d6d6d6' class="icon icon-tabler icon-tabler-brand-whatsapp" width="72" height="72" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div className={styles.insta_div}>
                    ...
                    <a className={styles.logo_svg} href={iglink} target='_blank'>
                        {/* INSTAGRAM SVG */}
                        <svg xmlns="http://www.w3.org/2000/svg" className={styles.insta_svg} stroke='#d6d6d6' class="icon icon-tabler icon-tabler-brand-instagram" width="72" height="72" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div className={styles.github_div}>
                    ...
                    <a className={styles.logo_svg} href={githublink} target='_blank'>
                        {/* GITHUB SVG */}
                        <svg xmlns="http://www.w3.org/2000/svg" className={styles.github_svg} stroke='#d6d6d6' class="icon icon-tabler icon-tabler-brand-github" width="72" height="72" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
